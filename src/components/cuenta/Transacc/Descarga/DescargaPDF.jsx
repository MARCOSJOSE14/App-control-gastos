...
import { isoDate } from '@/hooks/Fecha'
  ...
  return (
    <>
      <Modales fnAtras={camEstado} enlace={`/cuenta/${cuenta}`}>
        <div className='bg-white w-full pb-16 px-3 flex flex-col gap-3 pt-3 rounded' onClick={(e) => e.stopPropagation()}>
          ...
          <div className='flex justify-evenly gap-4'>
            ...
            <PDFDownloadLink document={<Exportar fecha={fecha} data={dataD} saldo={saldo} />} fileName='Transacciones.pdf'>
